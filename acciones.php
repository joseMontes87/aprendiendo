...
<script type="text/javascript">
	...
	switch (url){
		//Index------------------------------------------------------------------------------------
		case "http://localhost/aprendiendoPhpParaPartner/index.php":
			<?php
				//Index
		...
		//Insertar------------------------------------------------------------------------------------
		case "http://localhost/aprendiendoPhpParaPartner/insertar.php":
			<?php 			
		...
		//Modificar------------------------------------------------------------------------------------
		case "http://localhost/aprendiendoPhpParaPartner/modificar.php":
			<?php 
				if(isset($_POST['guardar'])){
					$descripcion=mysqli_real_escape_string($con,$_POST['descripcion']);
					$observaciones=mysqli_real_escape_string($con,$_POST['observaciones']);
		...
		//Registrar------------------------------------------------------------------------------------
		case "http://localhost/aprendiendoPhpParaPartner/registrar.php":
		<?php
		...
		//userConfig------------------------------------------------------------------------------------
		case "http://localhost/aprendiendoPhpParaPartner/userConfig.php":
			<?php 
				//HACER
			?>
		break;
		...
		//Login------------------------------------------------------------------------------------
		case "http://localhost/aprendiendoPhpParaPartner/login.php":
		<?php  
